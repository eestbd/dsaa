...
// Manager.cpp only resets metadata here
// ScoreBoard itself is managed by the caller and by the provided ScoreBoard APIs.
...
// Same-score ties broken by smaller player_id = higher rank.
// If the player does not exist, return -1.
